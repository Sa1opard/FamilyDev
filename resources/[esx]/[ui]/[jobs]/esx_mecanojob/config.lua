...
Config.Zones = {
	...
	VehicleSpawnPoint = {
		Pos   = {x = -162.39376831055, y = -1305.7768554688, z = 31.350660324097},
		Size  = {x = 1.5, y = 1.5, z = 1.0},
		Type  = -1
	},

	VehicleDeleter = {
		Pos   = {x = -181.40097045898, y = -1320.9149169922, z = 31.295978546143},
	...
	VehicleDelivery = {
		Pos   = {x = -212.1480255127, y = -1393.7038574219, z = 30.250492095947},
