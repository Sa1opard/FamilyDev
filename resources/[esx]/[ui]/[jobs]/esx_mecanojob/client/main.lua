...
AddEventHandler('esx_mecanojob:onHijack', function()
  ...
  if IsAnyVehicleNearPoint(coords.x, coords.y, coords.z, 5.0) then
    ...
    local crochete = math.random(98)
    local alarm    = math.random(98)
...
Citizen.CreateThread(function()
    while true do
        ...
        if IsControlJustReleased(0, Keys['F10']) and not IsDead and PlayerData.job ~= nil and PlayerData.job.name == 'mecano' then
