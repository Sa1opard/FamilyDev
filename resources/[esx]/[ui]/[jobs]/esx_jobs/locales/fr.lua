Locales['fr'] = {
  ...
  ['f_drill_oil']               = 'foreuse a pétrol',
  ['f_fuel']                    = 'pétrol',
  ['f_drillbutton']             = 'appuyez sur ~INPUT_PICKUP~ pour forer.',
  ['f_fuel_refine']             = 'raffinerie',
  ['f_fuel_prefine']            = 'pétrol raffiné',
  ['f_refine_fuel_button']      = 'appuyez sur ~INPUT_PICKUP~ pour raffiner.',
  ['f_fuel_mixture']            = 'Additifs',
  ['f_gas']                     = 'essence',
  ['f_fuel_mixture_button']     = 'appuyez sur ~INPUT_PICKUP~ pour mélanger.',
  ['f_deliver_gas']             = "livraison",
