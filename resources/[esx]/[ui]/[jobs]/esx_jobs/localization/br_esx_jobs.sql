...
INSERT INTO `items` (`name`, `label`) VALUES
  ('alive_chicken', 'Frango Vivo'),
  ('slaughtered_chicken', 'Frango Abatido'),
  ('packaged_chicken', 'Frango na Bandeja'),
  ('fish', 'Peixe'),
  ('stone', 'Pedra'),
  ('washed_stone', 'Pedra Limpa'),
  ('copper', 'Cobre'),
  ('iron', 'Ferro'),
  ('gold', 'Ouro'),
  ('diamond', 'Diamante'),
  ('wood', 'Madeira'),
  ('cutted_wood', 'Madeira Cortada'),
  ('packaged_plank', 'Tábua Embalada'),
  ('petrol', 'Petroleo'),
