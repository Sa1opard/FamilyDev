...
function checkSpeed()
	...
	finelevel = '40mph Over Limit'
        ...
        exports.pNotify:SendNotification({
            text = "<h2><center>Speed Camera</center></h2>" .. "</br>Vous avez reçu une amende pour excès de vitesse!</br>N° de plaque: " .. plate .. "</br>Montant de l'amande: $" .. fineamount .. "</br>Violation: " .. finelevel .. "</br>Limite de vitesse: " .. maxspeed .. "</br>Votre vitesse: " ..mphspeed,
            type = "error",
            timeout = 9500,
            layout = "centerLeft",
            queue = "left"
