...
-------------------------
		...
		if (IsControlPressed(1, Keys["LEFTSHIFT"]) and IsControlPressed(0, Keys["T"]) and (GetGameTimer() - GUI.Time) > 150) then
			TriggerEvent('NB:closeAllSubMenu')
			TriggerEvent('NB:closeAllMenu')
...
--------------------------------------------------------------------------------------------
		...
		if (IsControlPressed(0, Keys["F6"]) and PlayerData.job ~= nil and PlayerData.job.name == 'taxi' and not ESX.UI.Menu.IsOpen('default', 'esx_taxijob', 'taxi_actions_menu') and (GetGameTimer() - GUI.Time) > 150) then
			TriggerEvent('NB:closeAllSubMenu')
			TriggerEvent('NB:closeAllMenu')
			TriggerEvent('NB:openMenuTaxi')
			GUI.Time = GetGameTimer()
		end

  	if (IsControlPressed(0, Keys["F6"]) and PlayerData.job ~= nil and PlayerData.job.name == 'taxi' and ESX.UI.Menu.IsOpen('default', 'esx_taxijob', 'taxi_actions_menu') and (GetGameTimer() - GUI.Time) > 150) then
			TriggerEvent('NB:closeAllSubMenu')
			TriggerEvent('NB:closeAllMenu')
			GUI.Time = GetGameTimer()
		end
...
--------------------------------------- MANETTE
		...
		if (IsControlPressed(1, Keys["SPACE"]) and IsControlPressed(0, Keys["DOWN"]) and PlayerData.job ~= nil and PlayerData.job.name == 'taxi' and not ESX.UI.Menu.IsOpen('default', 'esx_taxijob', 'taxi_actions_menu') and (GetGameTimer() - GUI.Time) > 150) then
			TriggerEvent('NB:closeAllSubMenu')
			TriggerEvent('NB:closeAllMenu')
			TriggerEvent('NB:openMenuTaxi')
			GUI.Time  = GetGameTimer()
		...
		if (IsControlPressed(1, Keys["SPACE"]) and IsControlPressed(0, Keys["DOWN"]) and PlayerData.job ~= nil and PlayerData.job.name == 'taxi' and ESX.UI.Menu.IsOpen('default', 'esx_taxijob', 'taxi_actions_menu') and (GetGameTimer() - GUI.Time) > 150) then
			TriggerEvent('NB:closeAllSubMenu')
			TriggerEvent('NB:closeAllMenu')
			GUI.Time  = GetGameTimer()
		end
...
--------------------------------------------------------------------------------------------
-- Menu CarDealer -> esx_vehicleshop
--------------------------------------------------------------------------------------------

		if (IsControlPressed(0, Keys["F6"]) and PlayerData.job ~= nil and PlayerData.job.name == 'cardealer' and not ESX.UI.Menu.IsOpen('default', 'esx_vehicleshop', 'cardealer_actions') and (GetGameTimer() - GUI.Time) > 150) then
			TriggerEvent('NB:closeAllSubMenu')
			TriggerEvent('NB:closeAllMenu')
			TriggerEvent('NB:openMenuCarDealer')
			GUI.Time = GetGameTimer()
		end

		if (IsControlPressed(0, Keys["F6"]) and PlayerData.job ~= nil and PlayerData.job.name == 'cardealer' and ESX.UI.Menu.IsOpen('default', 'esx_vehicleshop', 'cardealer_actions') and (GetGameTimer() - GUI.Time) > 150) then
			TriggerEvent('NB:closeAllSubMenu')
			TriggerEvent('NB:closeAllMenu')
			GUI.Time = GetGameTimer()
		end
...
--------------------------------------- MANETTE
		...
		if (IsControlPressed(1, Keys["SPACE"]) and IsControlPressed(0, Keys["DOWN"]) and PlayerData.job ~= nil and PlayerData.job.name == 'cardealer' and not ESX.UI.Menu.IsOpen('default', 'esx_vehicleshop', 'cardealer_actions') and (GetGameTimer() - GUI.Time) > 150) then
			TriggerEvent('NB:closeAllSubMenu')
			TriggerEvent('NB:closeAllMenu')
			TriggerEvent('NB:openMenuCarDealer')
			GUI.Time  = GetGameTimer()
		...
		if (IsControlPressed(1, Keys["SPACE"]) and IsControlPressed(0, Keys["DOWN"]) and PlayerData.job ~= nil and PlayerData.job.name == 'cardealer' and ESX.UI.Menu.IsOpen('default', 'esx_vehicleshop', 'cardealer_actions') and (GetGameTimer() - GUI.Time) > 150) then
			TriggerEvent('NB:closeAllSubMenu')
			TriggerEvent('NB:closeAllMenu')
			GUI.Time  = GetGameTimer()
		end
...
AddEventHandler('NB:closeAllSubMenu', function()
	...
	TriggerEvent('NB:closeMenuCarDealer')
...
Citizen.CreateThread(function()
	while true do
		...
		(ESX.UI.Menu.IsOpen('default', 'esx_vehicleshop', 'cardealer_actions')) or
		(ESX.UI.Menu.IsOpen('default', 'esx_vehicleshop', 'citizen_interaction')) or
